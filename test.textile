---
title: jweslley/borborema @ GitHub
---
...
<head>
	...
	<title>jweslley/borborema @ GitHub</title>
	<link rel="stylesheet" href="http://jweslley.github.com/borborema/css/syntax.css"  type="text/css" media="screen"/>	
	<link rel="stylesheet" href="http://jweslley.github.com/borborema/css/site.css"  type="text/css" media="screen"/>	
</head>

<body>
  <a href="http://github.com/jweslley/borborema"><img style="position: absolute; top: 0; right: 0; border: 0;" src="http://s3.amazonaws.com/github/ribbons/forkme_right_darkblue_121621.png" alt="Fork me on GitHub" />
  </a>
  
  <div id="container">

    <div class="download">
      <a href="http://github.com/jweslley/borborema/zipball/master">
        <img border="0" width="90" src="http://github.com/images/modules/download/zip.png"></a>
      <a href="http://github.com/jweslley/borborema/tarball/master">
        <img border="0" width="90" src="http://github.com/images/modules/download/tar.png"></a>
    </div>
      
    <h1><a href="http://github.com/jweslley/borborema">borborema</a></h1>

    <div class="description">
         A simple Java API to submit jobs to the OurGrid infrastructure.
    </div>
...
public class Main {
  ...
  public static void main(final String[] args) throws Exception {
    ...
    bot
    .addJarFile(new File("borborema.jar"))   // adds the required jar(s)
...
See also the future <a href="http://github.com/jweslley/borborema/issues">features</a>.
...
You can download this project in either <a href="http://github.com/jweslley/borborema/zipball/master">zip</a> or <a href="http://github.com/jweslley/borborema/tarball/master">tar</a> formats.
    
You can also clone the project with <a href="http://git-scm.com">Git</a> by running:
<pre>$ git clone git://github.com/jweslley/borborema</pre>

<div class="footer">
  get the source code on GitHub : <a href="http://github.com/jweslley/borborema">jweslley/borborema</a>
</div>
